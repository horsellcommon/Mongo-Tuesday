...
const app = async (yargsObject) => {
  ...
  try {
    if (yargsObject.create) {
      ...
      //UPDATE
      const updateFilm = new Film(yargsObject.title, yargsObject.actor);
      await updateFilm.update(collection, yargsObject.key, yargsObject.filter)
      console.table(await updateFilm.read(collection));
